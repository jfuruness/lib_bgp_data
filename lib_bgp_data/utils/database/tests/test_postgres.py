...
class Test_Postgres:
    ...
    @pytest.mark.skip(reason="Issues with restart in unhinge")
    ...
    @pytest.mark.skip(reason="Issues with restart in rehinge")
    ...
    def test_restart_postgres(self):
        ...
        conn.execute('SELECT EXTRACT(epoch from current_timestamp - pg_postmaster_start_time()) as uptime')
